...
- [1 Surfaces, thin films, and 2D
  materials](#Surfaces,_thin_films,_and_2D_materials)
  - [1.1 Nomenclature](#Nomenclature)
    - [1.1.1 Surfaces](#Surfaces)
    - [1.1.2 Thin films](#Thin_films)
    - [1.1.3 2D materials](#2D_materials)
  - [1.2 Slab symmetry and
    stoichiometry](#Slab_symmetry_and_stoichiometry)
    - [1.2.1 Slab symmetry](#Slab_symmetry)
    - [1.2.2 Slab stoichiometry](#Slab_stoichiometry)
  - [1.3 Advice and recommendations](#Advice_and_recommendations)
    - [1.3.1 Creating slab models](#Creating_slab_models)
    - [1.3.2 In-plane lattice parameters](#In-plane_lattice_parameters)
    - [1.3.3 Out-of-plane lattice
      parameters](#Out-of-plane_lattice_parameters)
    - [1.3.4 Surface-energy calculations](#Surface-energy_calculations)
    - [1.3.5 Adsorption at a surface](#Adsorption_at_a_surface)
    - [1.3.6 Computing the work function](#Computing_the_work_function)
    - [1.3.7 Simulation of STM pictures](#Simulation_of_STM_pictures)
    - [1.3.8 Electrostatic corrections](#Electrostatic_corrections)
...
[![](https://vasp.at/wiki/images/thumb/f/fd/NaCl_001.png/300px-NaCl_001.png)](https://vasp.at/wiki/File:NaCl_001.png)

Fig 1. Side (a) and top (b) view of a symmetric and stoichiometric,
6-layer-thick NaCl 001 slab.

[![](https://vasp.at/wiki/images/thumb/f/f3/NaCl_111_asymm.png/300px-NaCl_111_asymm.png)](https://vasp.at/wiki/File:NaCl_111_asymm.png)

Fig 2. Side (a) and top (b) view of a non-symmetric but stoichiometric,
6-layer-thick NaCl 111 slab.

[![](https://vasp.at/wiki/images/thumb/c/ce/NaCl_111_symm.png/300px-NaCl_111_symm.png)](https://vasp.at/wiki/File:NaCl_111_symm.png)

Fig 3. Side (a) and top (b) view of a symmetric but non-stoichiometric,
5-layer-thick NaCl 111 slab.

[Symmetry](../redirects/Symmetry.md) and stoichiometry are important
concepts for surface slabs. Figs. 1 to 3 show three different surface
slabs of NaCl, a 001 and two 111 slabs. All 001 lattice planes contain
an equal amount of Na and Cl atoms, so slabs of all thicknesses are both
...
different [exchange-correlation
functional](../redirects/Exchange-correlation_functional.md).
They can also interfere with convergence during
...
Python packages ASE^([\[1\]](#cite_note-ase-1)) and
Pymatgen^([\[2\]](#cite_note-pymatgen-2)) both provide surface-building
capabilities. The following ASE code snippet creates an NaCl (001) slab
with six layers and 10 Å vacuum, for example:
...
Ni(111)](https://www.vasp.at/tutorials/latest/surface/part1/) for more
...
Please also consult our tutorial on [CO adsorption on
Ni(111)](https://www.vasp.at/tutorials/latest/surface/part2/) for more
detailed guidance.
...
## Tutorials
- Tutorial for [surface
  calculations](https://vasp.at/tutorials/latest/surface/part1/).
- Tutorial for [adsorption on
  surfaces](https://vasp.at/tutorials/latest/surface/part2/).
- Tutorial for [STM](https://vasp.at/tutorials/latest/surface/part3/).

## References
1.  [↑](#cite_ref-ase_1-0) [https://wiki.fysik.dtu.dk/ase/
    (2025).](https://wiki.fysik.dtu.dk/ase/)
2.  [↑](#cite_ref-pymatgen_2-0) [https://pymatgen.org/
    (2022).](https://pymatgen.org/)
3.  [↑](#cite_ref-boettger:prb:1994_3-0) [J. C. Boettger, Phys. Rev. B
    **49**, 16798 (1994).](https://doi.org/10.1103/PhysRevB.49.16798)
