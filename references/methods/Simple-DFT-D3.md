...
# Simple-DFT-D3
Simple
DFT-D3^([\[1\]](#cite_note-ehlert:joss:2024-1)[\[2\]](#cite_note-sdftd3_1-2)[\[3\]](#cite_note-sdftd3_2-3))
is an external package that implements the DFT-D3
method^([\[4\]](#cite_note-grimme:jcp:10-4)[\[5\]](#cite_note-grimme:jcc:11-5))
...
papers^([\[4\]](#cite_note-grimme:jcp:10-4)[\[5\]](#cite_note-grimme:jcc:11-5))
and simple DFT-D3
websites.^([\[2\]](#cite_note-sdftd3_1-2)[\[3\]](#cite_note-sdftd3_2-3))
...
|  |
|----|
| **Mind:** simple DFT-D3 may switch to a [smooth cutoff](https://github.com/dftd3/simple-dftd3/issues/199) by default, which will change results for periodic systems with respect to prior versions and especially compared to VASPs own implementation (see [DFT-D3](DFT-D3.md)). |
...
structures or run [MD simulations](../redirects/MD.md) with an approximate
treatment of vdW interactions.
...
## References
1.  [↑](#cite_ref-ehlert:joss:2024_1-0) [S. Ehlert, *Simple dft-d3:
...
2.  ↑ ^([a](#cite_ref-sdftd3_1_2-0)) ^([b](#cite_ref-sdftd3_1_2-1))
    [https://dftd3.readthedocs.io](https://dftd3.readthedocs.io/)
3.  ↑ ^([a](#cite_ref-sdftd3_2_3-0)) ^([b](#cite_ref-sdftd3_2_3-1))
    [https://github.com/dftd3](https://github.com/dftd3/)
4.  ↑ ^([a](#cite_ref-grimme:jcp:10_4-0))
    ^([b](#cite_ref-grimme:jcp:10_4-1)) [S. Grimme, J. Antony, S.
    Ehrlich, and S. Krieg, J. Chem. Phys. **132**, 154104
    (2010).](https://doi.org/10.1063/1.3382344)
5.  ↑ ^([a](#cite_ref-grimme:jcc:11_5-0))
    ^([b](#cite_ref-grimme:jcc:11_5-1)) [S. Grimme, S. Ehrlich, and L.
