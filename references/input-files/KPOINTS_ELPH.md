...
KPOINTS_ELPH is an optional
input file to perform an additional one-shot calculation after
self-consistency is reached in the context of an electron-phonon
calculation. The format is the same as for the
...
mesh, when the KPOINTS_ELPH
file should be used afterward.
...
href="/wiki/index.php?title=KPOINTS_ELPH&amp;veaction=edit&amp;section=1"
