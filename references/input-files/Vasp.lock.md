...
# vasp.lock
The vasp.lock file is only used in combination with
[ICHARG](../incar-tags/ICHARG.md)=5. In each SCF step before constructing
the new charge density VASP checks if the vasp.lock file is present, and
