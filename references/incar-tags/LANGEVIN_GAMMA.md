...
Description: LANGEVIN_GAMMA specifies the friction coefficients (in
ps⁻¹) for atomic degrees-of-freedom when using a Langevin thermostat (in
...
thermostat](../tutorials/Langevin_thermostat.md)^([\[1\]](#cite_note-allen:book:1991-1))
([MDALGO](MDALGO.md)=3), the friction coefficients γ for the
atomic degrees-of-freedom are specified (in ps⁻¹) using the
LANGEVIN_GAMMA-tag.
