...
Description: LWRITE_MMN_AMN=.TRUE. tells the VASP2WANNIER90 interface to
write the **wannier90.mmn** and **wannier90.amn** files.
...
LWRITE_MMN_AMN=.TRUE. in the [INCAR](../input-files/INCAR.md) file.
