...
LVACPOTAV switches on the computation of the vacuum potential, i.e., the
average of the local potential in the vacuum region. It computes the
average potential by searching regions that are field-free
...
- [1 Use in conjunction with the dipole
  correction](#Use_in_conjunction_with_the_dipole_correction)
- [2 Warnings](#Warnings)
  - [2.1 Vacuum region is likely too
    small](#Vacuum_region_is_likely_too_small)
  - [2.2 The minimum charge density in your cell may be too
...
A typical use case for LVACPOTAV is together with the dipole correction
(including tags [LDIPOL](LDIPOL.md) and
...
### Warnings
In case LVACPOTAV is not able to generate an accurate work function, the
following warnings may be found in the [OUTCAR](../output-files/OUTCAR.md)
file.
