...
where $\mathcal{T}(\epsilon)$ is the [transport distribution
...
and $\epsilon_\text{min}$=[ELPH_TRANSPORT_EMIN](ELPH_TRANSPORT_EMIN.md)
...
$w_k$ the weights due to the Simpson integration rule
and N=[TRANSPORT_NEDOS](TRANSPORT_NEDOS.md).
...
with $w_k$ and
$x_k$ the weights and abcissae of the Gauss-Legendre
quadrature rule.

## Related tags and articles\[<a
href="/wiki/index.php?title=ELPH_TRANSPORT_DRIVER&amp;veaction=edit&amp;section=1"
