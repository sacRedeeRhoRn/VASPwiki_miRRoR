...
ML_CTIFOR (units of
eV/Angstrom for [ML_CALGO](ML_CALGO.md)=0 and unitless for
[ML_CALGO](ML_CALGO.md)=1).
...
dependent. The initial default 0.002 is only sensible, if
ML_CTIFOR is automatically
updated ([ML_ICRITERIA](ML_ICRITERIA.md) = 1 or 2). If
[ML_ICRITERIA](ML_ICRITERIA.md) = 0 is used, it is
necessary to use significantly larger values around 0.02-0.06 for
ML_CTIFOR.
...
href="/wiki/index.php?title=ML_CTIFOR&amp;veaction=edit&amp;section=1"
