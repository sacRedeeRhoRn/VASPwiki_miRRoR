...
molecules or surfaces). `KERNEL_TRUNCATION/LCOARSEN`` = T` avoids
significantly increasing [FFT-grid
...
This procedure exploits the fact that [long-range
electrostatics](../redirects/Electrostatics.md) depends only on
