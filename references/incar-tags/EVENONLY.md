...
Description: EVENONLY=.TRUE. selects a subset of **k**-points for the
...
EVENONLY=.TRUE. selects a subset of **k**-points with *C*₁=*C*₂=*C*₃=1,
and *n*₁+*n*₂+*n*₃ even. It reduces the computational work load for HF
