<!-- Source: https://vasp.at/wiki/index.php/ML_MOPOT_RKM | revid: 35111 | retrieved: 2026-06-24 -->
<!-- © VASP wiki contributors. Licensed under GNU Free Documentation License 1.2 (GFDL 1.2). -->

# ML_MOPOT_RKM
ML_MOPOT_RKM = \[real\]  
Default: **ML_MOPOT_RKM** = 1.0 

Description: Specifies the width parameter of the Morse potentials used
as auxiliary potentials in thermodynamic integration
([VCAIMAGES](VCAIMAGES.md)).

------------------------------------------------------------------------

This parameter sets the width parameter $\beta$ of the following Morse potential
