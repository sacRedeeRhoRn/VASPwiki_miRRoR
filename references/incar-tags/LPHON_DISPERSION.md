...
Description: LPHON_DISPERSION requests the calculation of the phonon
dispersion along the q-point path supplied in file
[QPOINTS](../input-files/QPOINTS.md) (same format as
...
cell determined by VASP by setting LPHON_DISPERSION=.TRUE.
