...
[NMRCAR.magres](NMRCAR.magres.md) in [Magres
format](https://www.ccpnc.ac.uk/docs/magres). Mind that, while the
Magres format does not clearly state if the [macroscopic
