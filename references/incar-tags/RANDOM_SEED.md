...
specifies the seed of the random-number generator (compile VASP with
...
molecular dynamics simulation. The three integers of
RANDOM_SEED must fulfill these
conditions:
...
RANDOM_SEED looks like this:

    RANDOM_SEED =         248489752                0                0

The initial value of
RANDOM_SEED and the value
after each MD step are written to the [REPORT](../output-files/REPORT.md)
file.
...
href="/wiki/index.php?title=RANDOM_SEED&amp;veaction=edit&amp;section=1"
