...
Description: ISPIN specifies
whether a calculation is performed with or without spin polarization.
...
- ISPIN=1: VASP performs a
  non-spin-polarized calculation. Spin-up and spin-down electrons share
  a single charge density.

<!-- -->

- ISPIN=2: VASP performs a
  spin-polarized collinear calculation. Spin-up and spin-down electrons
...
## Related tags and articles\[<a href="/wiki/index.php?title=ISPIN&amp;veaction=edit&amp;section=1"
