...
Description: NGZF sets the number of grid points in the "fine" FFT grid
...
By default NGZF is set in accordance with the requested "precision" mode
...
Alternatively, NGZF can be set to a specific value in the
