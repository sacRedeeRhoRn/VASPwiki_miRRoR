...
Description: LIBMBD_C6AU defines the free-atom $C_6$ parameters ($\mathrm{Hartree}$ $\mathrm{bohr}^{6}$) used in
the
...
LIBMBD_C6AU allows to set values for the free-atom
$C_6$ parameters ($\mathrm{Hartree}$ $\mathrm{bohr}^{6}$) used in the
[Tkatchenko-Scheffler](../methods/Tkatchenko-Scheffler_method.md)
and [Many-body dispersion
energy](../methods/Many-body_dispersion_energy.md)
methods as implemented in the library libMBD of many-body dispersion
