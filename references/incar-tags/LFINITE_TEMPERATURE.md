...
Description: LFINITE_TEMPERATURE switches on the finite-temperature
formalism of many-body perturbation theory for
...
[ALGO](ALGO.md)=ACFDT, ACFDTR, ACFDTRK, and low-scaling [GW
calculations](../redirects/GW_calculations.md), i.e.,
[ALGO](ALGO.md)=EVGW0R, GWR\[K\].

For LFINITE_TEMPERATURE=.TRUE., a compressed
...
metallic systems. ^([\[1\]](#cite_note-Kaltak:PRB:2020-1)) To this end,
the electronic temperature is set with the k-point smearing parameter
[SIGMA](SIGMA.md) in units of eV, e.g. a value of
$\sigma=1 eV$ corresponds to a
electronic temperature of $T\approx 11 604 K$.
