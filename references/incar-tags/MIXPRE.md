...
Description: MIXPRE specifies the metric in the Broyden mixing
scheme([IMIX](IMIX.md)=4).
...
always improves the convergence speed. The best choice is MIXPRE=1 (i.e.
the default).
