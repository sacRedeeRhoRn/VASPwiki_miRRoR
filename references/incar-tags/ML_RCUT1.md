...
expansion of $\rho^{(2)}_i(r)$ yields the expansion coefficients
$c_{n00}^{i}$, which are used in practice to describe
the atomic environment; refer to the [theory of machine-learned force
fields](../methods/Machine_learning_force_field-_Theory.md)
for details. The tag ML_RCUT1
...
## Related tags and articles\[<a href="/wiki/index.php?title=ML_RCUT1&amp;veaction=edit&amp;section=1"
