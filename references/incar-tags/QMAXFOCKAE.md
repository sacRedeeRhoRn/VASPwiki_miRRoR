...
inspection of the VASP code (fast_aug.F). The default values are 6.0 Å⁻¹
if [NMAXFOCKAE](../redirects/NMAXFOCKAE.md)=1 (corresponding to 140
eV), and 5.0 and 10 Å⁻¹ (corresponding to 95 eV and 380 eV) for
[NMAXFOCKAE](../redirects/NMAXFOCKAE.md)=2.
