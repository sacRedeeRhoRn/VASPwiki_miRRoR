...
Description: NGX sets the number of grid points in the FFT grid along
the first lattice vector.

------------------------------------------------------------------------

By default NGX is set in accordance with the requested "precision" mode
...
Alternatively, NGX can be set to a specific value in the
