...
*n*<sub>1</sub>+*n*<sub>2</sub>+*n*<sub>3</sub> odd.
...
ODDONLY=.TRUE. selects a
subset of **k**-points with
*C*<sub>1</sub>=*C*<sub>2</sub>=*C*<sub>3</sub>=1, and
*n*<sub>1</sub>+*n*<sub>2</sub>+*n*<sub>3</sub> odd. It reduces the
...
## Related tags and articles\[<a href="/wiki/index.php?title=ODDONLY&amp;veaction=edit&amp;section=1"
