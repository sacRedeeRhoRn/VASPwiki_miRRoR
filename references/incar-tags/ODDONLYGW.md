...
Description: ODDONLYGW allows
to avoid the inclusion of the $\Gamma$ point
in the evaluation of response functions (in
<a href="/wiki/GW_calculations" class="mw-redirect"
title="GW calculations">GW calculations</a>).

------------------------------------------------------------------------

The independent particle polarizability $\chi_{{\mathbf{q}}}^0
({\mathbf{G}}, {\mathbf{G}}', \omega)$ is given by:
...
href="/wiki/index.php?title=ODDONLYGW&amp;veaction=edit&amp;section=1"
