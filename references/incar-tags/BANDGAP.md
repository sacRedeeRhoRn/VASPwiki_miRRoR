<!-- Source: https://vasp.at/wiki/index.php/BANDGAP | revid: 24375 | retrieved: 2026-06-24 -->
...
Uses Fermi weights to decide what valence and conduction bands are.
Reports the VBM, CBM, and fundamental gap to the OUTCAR file.

- BANDGAP=WEIGHT

Uses Fermi weights to decide what valence and conduction bands are.
Provides a comprehensive report of all band extrema.

- BANDGAP=KPOINT

Considers each **k** point individually to decide what valence and
...
The column *spin independent* is always present and reports the bandgap
ignoring the spin of the electron. The other two columns are only
visible for [ISPIN](ISPIN.md)=2 and describe the bandgap for
a given spin of the electron. The first block of rows show the band
edges of the fundamental bandgap and their corresponding **k**-point
coordinates. The second block reports analogous values for the direct
