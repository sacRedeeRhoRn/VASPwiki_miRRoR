...
Description: LNABLA=.TRUE.
evaluates the transversal expression for the frequency dependent
dielectric matrix.
...
$\epsilon^{(2)}_{\alpha \beta} (\omega) = \frac{4 \pi^2 e^2
\hbar^4}{\Omega \omega^2 m_e^2} \mathrm{lim}_{\mathbf{q} \rightarrow 0}
\sum_{c,v, \mathbf{k}} 2 w_\mathbf{k} \delta(
...
## Related tags and articles\[<a href="/wiki/index.php?title=LNABLA&amp;veaction=edit&amp;section=1"
