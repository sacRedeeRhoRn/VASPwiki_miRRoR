...
- `ML_OUTPUT_MODE`` = 1`:
  **Normal operation**, output is written as usual in ab-initio
  molecular-dynamics simulations.
- `ML_OUTPUT_MODE`` = 0`:
  **Reduced file output mode**, in contrast to normal operation the
...
href="/wiki/index.php?title=ML_OUTPUT_MODE&amp;veaction=edit&amp;section=1"
