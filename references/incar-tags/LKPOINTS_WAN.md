...
Description: LKPOINTS_WAN controlls whether VASP reads the
[KPOINTS_WAN](../input-files/KPOINTS_WAN.md) file.

------------------------------------------------------------------------

To avoid reading the [KPOINTS_WAN](../input-files/KPOINTS_WAN.md) file
without removing it from the working directory, the LKPOINTS_WAN tag can
be set to `.FALSE.` in the [INCAR](../input-files/INCAR.md) file.
