...
Description: This tag specifies the width $\sigma_\text{atom}$ of the Gaussian functions used for broadening the
atomic distributions of the angular descriptor
$\rho^{(3)}_i(r)$ within the machine learning force
field method.
...
The tag ML_SION2 sets the
width $\sigma_\text{atom}$ of the above Gaussian function (see [this
...
## Related tags and articles\[<a href="/wiki/index.php?title=ML_SION2&amp;veaction=edit&amp;section=1"
