...
Description: NGZ sets the number of grid points in the FFT grid along
the third lattice vector.

------------------------------------------------------------------------

By default NGZ is set in accordance with the requested "precision" mode
...
Alternatively, NGZ can be set to a specific value in the
