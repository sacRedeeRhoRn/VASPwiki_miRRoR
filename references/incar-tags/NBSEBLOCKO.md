<!-- Source: https://vasp.at/wiki/index.php/NBSEBLOCKO | revid: 27485 | retrieved: 2026-06-24 -->
...
Description: NBSEBLOCKO
specifies the blocking factor for the occupied states when setting up
the BSE Hamiltonian.
...
|  |
|----|
| **Mind:** Parallelization over bands with [NBSEBLOCKV](NBSEBLOCKV.md) does not work with the old BSE driver, i.e., [IBSE](IBSE.md)=0 |
...
|  |
|----|
| **Mind:** The [NBSEBLOCKV](NBSEBLOCKV.md) and NBSEBLOCKO tags are available as of VASP.6.5.0 |

## Related tags and sections\[<a
href="/wiki/index.php?title=NBSEBLOCKO&amp;veaction=edit&amp;section=1"
