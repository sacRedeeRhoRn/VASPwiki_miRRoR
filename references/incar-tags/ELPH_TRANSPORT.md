...
coefficients from the linearized Boltzmann transport equation. In this
framework, the transport coefficients are calculated from various
relaxation-time approximations selectable via
