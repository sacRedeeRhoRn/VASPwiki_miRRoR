...
Description: VDW_S6 sets a parameter in the damping function of van der
Waals methods.

------------------------------------------------------------------------

VDW_S6 allows to set the value of a parameter in the following methods:

- Scaling $s_{6}$ of the dipole-dipole
  dispersion of the [DFT-D2](../methods/DFT-D2.md)
  ...
  ([IVDW](IVDW.md)=2 and 21). VDW_S6 can be used for both
