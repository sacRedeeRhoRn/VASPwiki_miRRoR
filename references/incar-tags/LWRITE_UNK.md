...
Description: LWRITE_UNK decides whether the cell-periodic part of the
relevant Bloch functions is written.

------------------------------------------------------------------------

For LWRITE_UNK=True, VASP writes the cell-periodic part of the Kohn–Sham
orbitals in spin channel s at k point p to the file
...
WANNIER90, we refer to the [WANNIER90
