...
- [CLNT](CLNT.md): This tag selects the species holding the
  ...
  files.
- [CLN](CLN.md): Specifies the $n$ quantum number of the excited electron.
- [CLL](CLL.md): Specifies the $l$ quantum number of the excited electron.
...
- [CH_SIGMA](CH_SIGMA.md): The broadening of the spectrum
  ...
  small broadening
  [CH_SIGMA](CH_SIGMA.md)$\le$0.001 in the calculations and to broaden the spectrum in
  ...
  set [ALGO](ALGO.md)=*None* together with the new parameters
