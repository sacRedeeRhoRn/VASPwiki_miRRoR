...
Description: LH5 determines whether the output is written to the legacy
files ([CHGCAR](../input-files/CHGCAR.md), [CHG](../output-files/CHG.md),
[WAVECAR](../input-files/WAVECAR.md)) or the
[vaspwave.h5](../output-files/Vaspwave.h5.md) file. Hence, setting
LH5=.TRUE. will suppress legacy file output all together. Whether or not
the charge density or wave functions are written to
