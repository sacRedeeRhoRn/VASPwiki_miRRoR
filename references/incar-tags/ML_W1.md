...
Description: This tag defines the weight $\beta$ for the radial (and angular) descriptor within the machine
learning force field method (see [this
section](../methods/Machine_learning_force_field-_Theory.md)).

------------------------------------------------------------------------

The weight for the angular descriptor $W_{2}$ is internally computed from the weight of the radial
descriptor $W_{1}$ as:
