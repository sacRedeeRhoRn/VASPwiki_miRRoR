...
Description: INCREM controls the transformation velocity in the
slow-growth approach (in case VASP was compiled with
...
geometric parameter with `STATUS=0` is increased by INCREM in every
simulation step.
