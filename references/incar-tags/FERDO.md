...
Description: FERDO sets the occupancies of the states in the down-spin
channel for [ISMEAR](ISMEAR.md)=-2 and
[ISPIN](ISPIN.md)=2.
...
band-index runs fastest. The occupancies must be between 0 and 1. FERDO
has the same format as [FERWE](FERWE.md), please consider the
notes on that page when setting FERDO.
