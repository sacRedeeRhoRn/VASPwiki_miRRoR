...
Description: HFSCREEN (in Å⁻¹) specifies the range-separation parameter
in [range-separated hybrid
...
HFSCREEN will switch from the PBE0 functional to, e.g., the closely
related
[HSE03](../methods/List_of_hybrid_functionals.md)
(HFSCREEN=0.3) or
[HSE06](../methods/List_of_hybrid_functionals.md)
(HFSCREEN=0.2) functionals. It also needs to be set for
dielectric-dependent hybrid functionals (DDH) and doubly screened hybrid
(DSH) functionals, see [LMODELHF](LMODELHF.md).
