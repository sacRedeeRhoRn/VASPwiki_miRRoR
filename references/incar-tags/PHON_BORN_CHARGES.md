...
Description: PHON_BORN_CHARGES
sets the Born effective charges to be used for the dipole-dipole
...
(PHON_BORN_CHARGES) which can
be obtained in a separate VASP calculation using the
...
href="/wiki/index.php?title=PHON_BORN_CHARGES&amp;veaction=edit&amp;section=1"
