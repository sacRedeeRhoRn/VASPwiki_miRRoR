...
Since VASP 6.2.0, NUM_WANN also determines the number of Wannier
...
not necessary to set NUM_WANN. In this case, the number of Wannier
orbitals is automatically set equal to the number of local functions.
