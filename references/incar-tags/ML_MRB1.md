...
Description: This tag sets the number $N_\text{R}^0$ of radial basis functions used to expand the
radial descriptor $\rho^{(2)}_i(r)$
...
function above is transformed into a discrete set of numbers by
expanding it into a set of radial basis functions $\chi_{n0}(r)$ (see [this
...
The tag ML_MRB1 sets the number $N_\text{R}^0$ of radial basis functions to use in this expansion.
