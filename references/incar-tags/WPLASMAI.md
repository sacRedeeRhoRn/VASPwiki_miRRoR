...
Description: WPLASMAI sets the complex shift (in eV) for the Drude term
...
transitions. When WPLASMAI\>0 in the calculation of the dielectric
function with [LOPTICS](LOPTICS.md), these intraband
transitions are accounted for via the Drude term:
...
phonons, impurities, and electron-electron interactions. If WPLASMAI\>0,
the Drude term is introduced in both the density-density and
