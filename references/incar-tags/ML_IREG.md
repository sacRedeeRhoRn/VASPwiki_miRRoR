...
- ML_IREG=1: The (initial) precision
  ([ML_SIGV0](ML_SIGV0.md)) and noise
  ([ML_SIGW0](ML_SIGW0.md)) parameters are kept constant.
- ML_IREG=2: The parameters are optimized (default).

For the optimization of the noise parameter $\sigma_{\mathrm{v}}^{2}$ see [this
section](../redirects/Machine_learning_force_fields-_Theory.md).
