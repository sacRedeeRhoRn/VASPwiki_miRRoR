...
Description: BSEELECTRON sets the coordinates of the fixed electron of
the exciton wavefunction

------------------------------------------------------------------------

If BSEELECTRON is set in a BSE calculation, VASP computes exciton
...
[BSE calculations](../redirects/BSE_calculations.md), [Plotting
exciton
