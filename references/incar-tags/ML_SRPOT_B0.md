...
This parameters sets the height $b$ of
the following repulsive exponential potential

$V(r) = b e^{-(r/\sigma)^n}.$

The height $b$ should be chosen rather
high, since the sole purpose of this potential is to repell other atoms
that come close to the selected atoms chosen by
