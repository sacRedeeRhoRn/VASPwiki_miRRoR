...
If LORBMOM=.TRUE. is set, VASP will use the projectors of the PAW
potentials to calculate the orbital angular moment within the PAW
spheres, and write them to the [OUTCAR](../output-files/OUTCAR.md) file.
Look for
