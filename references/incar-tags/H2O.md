...
[O dimer](../misc/O_dimer.md) \> [CO](CO.md) \> [CO
vibration](../misc/CO_vibration.md) \> [CO partial
DOS](../misc/CO_partial_DOS.md) \> H2O \> [H2O
vibration](../misc/H2O_vibration.md) \> [H2O molecular
...
## Download
[H2O.tgz](https://vasp.at/wiki/images/8/85/H2O.tgz "H2O.tgz")
