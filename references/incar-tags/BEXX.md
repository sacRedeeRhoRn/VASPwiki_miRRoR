...
Description: BEXX specifies the fraction of short-range exact exchange
in range-separated hybrid-functionals constructed with
...
The BEXX tag specifies the fraction of short-range exact exchange in
range-separated hybrid-functionals. This tag can be used only when
