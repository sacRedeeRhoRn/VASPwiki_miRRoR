...
Description: VDW_SR8 sets the
radii scaling $s_{r,8}$ in
the dipole-quadrupole zero-damping function of the DFT-D3 method.
...
VDW_SR8 allows to set the
radii scaling $s_{r,8}$ in
the dipole-quadrupole zero-damping function of the DFT-D3 method.
VDW_SR8 can be used for both
...
## Related tags and articles\[<a href="/wiki/index.php?title=VDW_SR8&amp;veaction=edit&amp;section=1"
