...
Description: ADDGRID determines whether an additional support grid is
used for the evaluation of the augmentation charges.

------------------------------------------------------------------------

When ADDGRID=.TRUE. VASP uses an additional support grid for the
evaluation of the augmentation charges. This grid contains 8 times more
points than the standard "fine" grid
...
[ENAUG](ENAUG.md), [ENMAX](../redirects/ENMAX.md),
