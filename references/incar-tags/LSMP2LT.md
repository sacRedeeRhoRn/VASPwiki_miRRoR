...
Description: LSMP2LT selects a stochastic Laplace transformed MP2
algorithm.

------------------------------------------------------------------------

If LSMP2LT=.TRUE. and [ALGO](ALGO.md)=ACFTDRK is set, a
quartic scaling stochastic Laplace transformed MP2 algorithm is
selected.^([\[1\]](#cite_note-schaefer:JCP2017-1))
...
1.  [↑](#cite_ref-schaefer:JCP2017_1-0) [T. Schäfer, B. Ramberger,
    and G. Kresse, J. Chem. Phys. **146**, 104101
