...
For LCHARG = T  (default), the files [CHGCAR](../input-files/CHGCAR.md) and
[CHG](../output-files/CHG.md) are written. If [LH5](LH5.md) = T , the
charge density is instead written to
