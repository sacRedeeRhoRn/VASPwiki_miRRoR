...
Description: NBANDSO determines how many occupied orbitals are included
in the Casida/[BSE
calculations](../redirects/BSE_calculations.md) or time
propagation ([ALGO](ALGO.md)=TIMEEV.

------------------------------------------------------------------------

For the time-propagation algorithm increasing NBANDSO only modestly
...
VASP always uses the orbitals closest to the Fermi-level, and NBANDSO
($N_{\mathrm{occ}}$) and
[NBANDSV](NBANDSV.md) ($N_{\mathrm{virtual}}$) determines how many occupied and
...
occupied states are included). For highly accurate results,
