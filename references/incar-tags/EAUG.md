...
Description: EAUG specifies the energy cutoff for the plane-wave
representation for the augmentation charges in eV for the
pseudopotential it is read from.

------------------------------------------------------------------------

For a multi-element [POTCAR](../input-files/POTCAR.md) file, the maximum
EAUG determines the cutoff energy for the plane-wave representation of
