...
The tag NCORE_IN_IMAGE1
defines how many of cores are used for the first image (01). The
remainder of the cores is used for the second image (working in the
subdirectory 02).

## Related tags and articles\[<a
href="/wiki/index.php?title=NCORE_IN_IMAGE1&amp;veaction=edit&amp;section=1"
