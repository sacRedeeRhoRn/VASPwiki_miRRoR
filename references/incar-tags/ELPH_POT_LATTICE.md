...
needs to be specified manually, ELPH_POT_LATTICE can be used.

`ELPH_POT_LATTICE`` = a1x a1y a1z a2x a2y a2z a3x a3y a3z` specifies the
three primitive lattice vectors $\mathbf{a}_1$, $\mathbf{a}_2$ and
$\mathbf{a}_3$ in Cartesian
coordinates. These lattice vectors are then used to construct the
primitive-cell information in the
