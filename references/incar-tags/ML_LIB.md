...
Description: ML_LIB enables/disables the use of the [VASPml C++
...
integration method. The ML_LIB tag allows to switch seamlessly between
the two code paths without the need to recompile VASP.
