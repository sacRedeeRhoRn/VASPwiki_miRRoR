...
is summed up for all selected bands or separated and printed out in
different files.
...
[EINT](EINT.md) tags. If LSEPB is set to .TRUE., separate
PARCHG.nb.ALLK or PARCHG.nb.nk files are created, dependent on the
[LSEPK](LSEPK.md) tag. If LSEPB = .FALSE., the output is
written to [PARCHG](../output-files/PARCHG.md) or PARCHG.ALLB.nk, again
depending on [LSEPK](LSEPK.md).

Here are four examples to illustrate the interplay of LSEPB and
...
- `LSEPB`` = .FALSE.`, [`LSEPK`](LSEPK.md)` = .FALSE.`

|                          |
|--------------------------|
| **output files:** PARCHG |

- `LSEPB`` = .TRUE.`, [`LSEPK`](LSEPK.md)` = .FALSE.`

|                                                                        |
|------------------------------------------------------------------------|
| **output files:** PARCHG.0009.ALLK, PARCHG.0010.ALLK, PARCHG.0011.ALLK |

- `LSEPB`` = .FALSE.`, [`LSEPK`](LSEPK.md)` = .TRUE.`

|                                                      |
|------------------------------------------------------|
| **output files:** PARCHG.ALLB.0001, PARCHG.ALLB.0034 |

- `LSEPB`` = .TRUE.`, [`LSEPK`](LSEPK.md)` = .TRUE.`
