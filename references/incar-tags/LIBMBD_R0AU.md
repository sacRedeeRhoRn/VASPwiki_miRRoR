<!-- Source: https://vasp.at/wiki/index.php/LIBMBD_R0AU | revid: 24451 | retrieved: 2026-06-24 -->
<!-- © VASP wiki contributors. Licensed under GNU Free Documentation License 1.2 (GFDL 1.2). -->

# LIBMBD_R0AU


LIBMBD_R0AU = \[real array\] 

Description: LIBMBD_R0AU
defines the free-atom $R_0$
...
LIBMBD_R0AU allows to set
values for the free-atom $R_0$
parameters (bohr) used in the
[Tkatchenko-Scheffler](../methods/Tkatchenko-Scheffler_method.md)
and [Many-body dispersion
energy](../methods/Many-body_dispersion_energy.md)
...
value has to be provided. The values are internally passed to the third
...
href="/wiki/index.php?title=LIBMBD_R0AU&amp;veaction=edit&amp;section=1"
...
tag](https://vasp.at/wiki/index.php/Special-Search/-LIBMBD_R0AU-_incategory-Examples)

## References\[<a
href="/wiki/index.php?title=LIBMBD_R0AU&amp;veaction=edit&amp;section=2"
class="mw-editsection-visualeditor"
