...
# IBZKPT
The IBZKPT file is compatible with the
[KPOINTS](../input-files/KPOINTS.md) file and is generated if the
automatic k-mesh generation is selected in the
[KPOINTS](../input-files/KPOINTS.md) file. IBZKPT contains the k-point
...
IBZKPT maybe copied to [KPOINTS](../input-files/KPOINTS.md) to save time,
if one [KPOINTS](../input-files/KPOINTS.md) set is used several times.
