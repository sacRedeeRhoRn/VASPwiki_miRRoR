...
# CONTCAR ELPH
The CONTCAR_ELPH file is an output file of a [supercell
...
The CONTCAR_ELPH file can be renamed and used as the
[POSCAR](../input-files/POSCAR.md) input for a subsequent electron-phonon
calculation in the primitive cell, e.g. [band-structure
