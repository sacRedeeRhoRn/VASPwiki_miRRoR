...
For each band *n* at **k**σ the body of the PRJCAR lists the index *n*
and eigenenergy ε_(n**k**σ), followed by one or more rows with a total
of `NKPTS_PRIME` entries K_(n**k**σ**k′**), one for each point **k′**.
