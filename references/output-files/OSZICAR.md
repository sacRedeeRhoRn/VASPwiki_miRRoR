<!-- Source: https://vasp.at/wiki/index.php/OSZICAR | revid: 29868 | retrieved: 2026-06-24 -->
...
*N* is the number of electronic steps, *E* the current free energy, *dE*
the change in the free energy from the last to the current step and *d
eps* the change in the bandstructure energy. Furthermore *ncg* is the
number of evaluations of the Hamiltonian acting on a wavefunction, *rms*
is the norm of the residuum ($R=H - \epsilon S |
\phi\rangle$) of the trial wave functions (i.e. their
approximate error) and *rms(c)* is the difference between input and
...
*T* corresponds to the current temperature and *E* to the total free
energy (including the kinetic energy of the ions and the energy of the
Nosé thermostat). *F* and *E0* are the same as above. *EK* is the
kinetic energy, *SP* is the potential energy of the Nosé thermostat and
