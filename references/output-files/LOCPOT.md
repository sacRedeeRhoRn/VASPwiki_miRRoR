...
# LOCPOT
The LOCPOT file stores the local potential (in eV). The definition of
the written local potential depends on the settings for
[LVTOT](../incar-tags/LVTOT.md), [LVHAR](../incar-tags/LVHAR.md), and
...
$B_1$, $B_2$, and $B_3$ in the basis
defined by [SAXIS](../incar-tags/SAXIS.md) (see [LOCPOT-format issue for
