...
cartesian sampling points $N_x, N_y, N_z$ are written, followed by $ELF(x,y,z)$
with $x$ being the
fastest and $z$ the
slowest index.
...
ELFCAR file. This can be done
by specifying [PREC](../incar-tags/PREC.md)=*High* in the
