...
partial DOS of CO on Ni 111 surface \> [vibrational frequencies of CO on
Ni 111
...
[![](https://vasp.at/wiki/images/thumb/a/a4/Fig_CO_on_Ni111_LDOS_1.png/400px-Fig_CO_on_Ni111_LDOS_1.png)](https://vasp.at/wiki/File:Fig_CO_on_Ni111_LDOS_1.png)

- CO $5\sigma, 1\pi, 2\pi^{\*}$ bonds.
- From comparison with substrate LDOS:
  - Hybridization with Ni-$d_{3z^{2}-r^{2}}$.
  - No interaction with $d_{xy}$ due to
    symmetry.
...
[![](https://vasp.at/wiki/images/thumb/a/a6/Fig_CO_on_Ni111_LDOS_2.png/300px-Fig_CO_on_Ni111_LDOS_2.png)](https://vasp.at/wiki/File:Fig_CO_on_Ni111_LDOS_2.png)

- $\epsilon_{\mathrm{F}} = 1.65$ eV
  (from [OUTCAR](../output-files/OUTCAR.md) file.

&nbsp;

- Vacuum-potential at 8.24/6.77 eV: $\Phi_{\mathrm{CO}}=6.58,\Phi_{\mathrm{clean}}=5.11$ eV.
...
## Download
[COonNi111_LDOS.tgz](https://vasp.at/wiki/images/7/7b/COonNi111_LDOS.tgz "COonNi111 LDOS.tgz")
