...
Ni 100 surface relaxation \> [Ni 100 surface
DOS](Ni_100_surface_DOS.md) \> [Ni 100 surface
...
- Energy changes during relaxation from -25.556 to -25.571 eV which
  gives a relaxation energy of $E^{\mathrm{rel}} =
  -15$ meV. Use p4vasp to check the convergence:

[![](https://vasp.at/wiki/images/thumb/9/9c/Fig_Ni_100_surfrel_1.png/600px-Fig_Ni_100_surfrel_1.png)](https://vasp.at/wiki/File:Fig_Ni_100_surfrel_1.png)
...
$\sigma = \sigma^{\mathrm{unrel}} +
E^{\mathrm{rel}} = 0.84$ eV.
...
[![](https://vasp.at/wiki/images/thumb/8/83/Fig_Ni_100_surfrel_2.png/800px-Fig_Ni_100_surfrel_2.png)](https://vasp.at/wiki/File:Fig_Ni_100_surfrel_2.png)

## Download
[Ni100clean_rel.tgz](https://vasp.at/wiki/images/d/d5/Ni100clean_rel.tgz "Ni100clean rel.tgz")
