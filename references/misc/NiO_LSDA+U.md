<!-- Source: https://vasp.at/wiki/index.php/NiO_LSDA%2BU | revid: 36490 | retrieved: 2026-06-24 -->
...
- Switching on DFT+U using Dudarev's approach
  ([LDAUTYPE](../incar-tags/LDAUTYPE.md)=2).
- [LDAUL](../incar-tags/LDAUL.md) selects the l quantum number for which on
  site interaction is added (-1 = no on site interaction).
- The U and J parameters have to be specified.
- Print occupation matrices in the [OUTCAR](../output-files/OUTCAR.md) file
