...
Ni 100 surface DOS \> [Ni 100 surface
...
- N.B.: We want to use the optimized structure of [Ni 100 surface
  ...
  want to run Ni 100 surface DOS.
...
## Calculation
- At the end of the
  [OUCAR](https://vasp.at/wiki/index.php/index.php)")
  file the information on the local charge and magnetization is given.
...
[![](https://vasp.at/wiki/images/thumb/d/d7/Fig_Ni_100_surfDOS_1.png/500px-Fig_Ni_100_surfDOS_1.png)](https://vasp.at/wiki/File:Fig_Ni_100_surfDOS_1.png)

- The DOS of can be plotted using p4vasp:

[![](https://vasp.at/wiki/images/thumb/4/40/Fig_Ni_100_surfDOS_2.png/800px-Fig_Ni_100_surfDOS_2.png)](https://vasp.at/wiki/File:Fig_Ni_100_surfDOS_2.png)

## Download
[Ni100clean_LDOS.tgz](https://vasp.at/wiki/images/6/63/Ni100clean_LDOS.tgz "Ni100clean LDOS.tgz")
