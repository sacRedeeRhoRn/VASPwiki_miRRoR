...
Kohn and Luttinger.^([\[1\]](#cite_note-KohnLuttinger:PR:1960-1)) This
...
$\beta=1/T$ of the
system.^([\[2\]](#cite_note-Matsubara:PTP:1955-2)) More precisely,
...
Minimax-Isometry method.^([\[3\]](#cite_note-Kaltak:PRB:2020-3)) This
approach converges exponentially with the number of considered frequency
points.

1.  [↑](#cite_ref-KohnLuttinger:PR:1960_1-0) [W. Kohn and J. M.
    Luttinger, Phys. Rev. **118**, 41
    (1960).](https://doi.org/10.1103/PhysRev.118.41)
2.  [↑](#cite_ref-Matsubara:PTP:1955_2-0) [T. Matsubara, Prog. Theor.
    Phys. **14**, 351 (1955).](https://doi.org/10.1143/PTP.14.351)
3.  [↑](#cite_ref-Kaltak:PRB:2020_3-0) [M. Kaltak and G. Kresse, Phys.
    Rev. B. **101**, 205145
