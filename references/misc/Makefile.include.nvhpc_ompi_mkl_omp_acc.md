<!-- Source: https://vasp.at/wiki/index.php/Makefile.include.nvhpc_ompi_mkl_omp_acc | revid: 35431 | retrieved: 2026-06-24 -->
...
# makefile.include.nvhpc_ompi_mkl_omp_acc
    ...
    # For Blackwell (cc100 and above):
    #   - the CUDA version needs to be 13.0 or higher.
    #   - cc100 (or higher) may not be combined with lower compute capabilities.
    # Uncomment the line below
    #GPU         = -gpu=cc100,cuda13.1
