...
- [1 Step-by-step instructions](#Step-by-step_instructions)
  - [1.1 Step 1 (optional): Calculate the chemical shielding using a
...
^([\[3\]](#cite_note-dewijs:laskowski:jcp:2017-3)).
...
[`ICHARG`](../incar-tags/ICHARG.md)` = 11` start a chemical shielding
calculation for each individual **k** point in the first Brillouin zone
(IBZ) separately, starting from [CHGCAR](../input-files/CHGCAR.md). The
shieldings can then be calculated as a **k** point weighted average of
the symmetrized shieldings of the individual **k** points.

### Additional tags
To ensure tight precision, the precision should be set to
[`PREC`](../incar-tags/PREC.md)` = Accurate`, rather than `Normal`.
...
be used
^([\[4\]](#cite_note-dewijs:jcp:2013-4)[\[5\]](#cite_note-dewijs:jcp:2021-5)).
...
3.  [↑](#cite_ref-dewijs:laskowski:jcp:2017_3-0) [G. A. de Wijs, R.
...
4.  [↑](#cite_ref-dewijs:jcp:2013_4-0) [F. Vasconcelos, G.A. de
...
5.  [↑](#cite_ref-dewijs:jcp:2021_5-0) [G.A. de Wijs, G.
