<!-- Source: https://vasp.at/wiki/index.php/Atoms_and_Molecules_-_Tutorial | revid: 35752 | retrieved: 2026-06-24 -->
...
1.  [O atom](../misc/O_atom.md)
2.  [O atom
    spinpolarized](../misc/O_atom_spinpolarized.md)
3.  [O atom spinpolarized low
    symmetry](../misc/O_atom_spinpolarized_low_symmetry.md)
4.  [O dimer](../misc/O_dimer.md)
5.  [CO](../incar-tags/CO.md)
6.  [CO vibration](../misc/CO_vibration.md)
7.  [CO partial DOS](../misc/CO_partial_DOS.md)
8.  [H2O](../incar-tags/H2O.md)
9.  [H2O vibration](../misc/H2O_vibration.md)
10. [H2O molecular
    dynamics](../misc/H2O_molecular_dynamics.md)
11. [Further things to
    try](../misc/At_and_mol_further.md)
